 ...
 */
 if( !class_exists('Kidschool_description_Widget') ){
	class Kidschool_description_Widget extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_ops = array( 'description' => esc_html__('Our short description  .','kidschool'),'customize_selective_refresh' => true, );
			parent:: __construct('Kidschool_description_Widget', esc_html__('Kidschool: Short Description','kidschool'),$widget_ops );
		}
		/**
			...
			<?php echo esc_html($args['before_widget']); ?>
				<div class="single-footer">
					<div class="footer-logo">
						...
						" alt="<?php echo esc_attr__('Footer logo','kidschool'); ?>"></a>
					</div>
		...
		?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php echo esc_html__('Upload Image:','kidschool');?></label>
					...
					<a href="#" id="custom_media_button" style="margin-top:10px;" class="button button-primary custom_media_button"><?php esc_html_e('Upload', 'kidschool'); ?></a>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php echo esc_html__('Content:' ,'kidschool') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php echo esc_html__('Facebook Link:' ,'kidschool') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php echo esc_html__('Google Plus Link:' ,'kidschool') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php echo esc_html__('Twitter Link:' ,'kidschool') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('rss')); ?>"><?php echo esc_html__('Rss Link:' ,'kidschool') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('linked')); ?>"><?php echo esc_html__('Linkedin Link:' ,'kidschool') ?></label>
...
function Kidschool_description_Widget() {
    register_widget( 'Kidschool_description_Widget' );
}
add_action( 'widgets_init', 'Kidschool_description_Widget' );